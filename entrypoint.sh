...
java -classpath ${GIT_PROJECT}/jmeterinfo/zerotest.jar:${GIT_PROJECT}/jmeterinfo/*.jar:${GIT_PROJECT}/jmeterinfo/junit-4.12.jar:${JMETER_LIB_EXT}/*.jar:${JMETER_LIB_JUNIT}/*.jar:${JMETER_LIB}/*.jar org.junit.runner.JUnitCore com.jcg.selenium.GoogleSearchTest 
